  ...
  const features = [
    {
      ...
      description:
        "Pixel-perfect interfaces that adapt seamlessly across all devices",
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Lightning Fast",
      description:
        "Optimized for speed with <2s load times and 95+ PageSpeed scores",
    },
    {
      icon: <Code2 className="w-6 h-6" />,
      title: "Clean Code",
      description:
        "Maintainable, scalable architecture using modern frameworks",
    },
    {
      icon: <Palette className="w-6 h-6" />,
      title: "Custom Design",
      description:
        "Unique, brand-focused designs that convert visitors to customers",
    },
    {
    ...
    <section className="py-12 md:py-16 lg:py-20 bg-[#14141A] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          ...
          >
            Custom web and mobile applications engineered for performance,
            ...
            ([category, technologies], categoryIndex) => (
              ...
              >
                <div className="flex items-center space-x-2 mb-4">
                  {category === "frontend" && (
                    <Monitor className="w-5 h-5 text-[#00D0FF]" />
                  )}
                  {category === "backend" && (
                    <Code2 className="w-5 h-5 text-[#00D0FF]" />
                  )}
                  {category === "mobile" && (
                    <Smartphone className="w-5 h-5 text-[#00D0FF]" />
                  )}
                  {category === "devops" && (
                    <Rocket className="w-5 h-5 text-[#00D0FF]" />
                  )}
                  <h4 className="text-white uppercase text-sm font-mono">
                    {category}
                  </h4>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "UI/UX design with interactive prototypes and user testing",
              },
              {
                step: "03",
                title: "Development & Testing",
                desc: "Agile development with continuous integration and QA",
              },
              {
                step: "04",
              ...
              >
                <div className="bg-[#1A1A22] border border-[#00D0FF]/20 rounded-lg p-6 h-full hover:border-[#75FF00] transition-all duration-300">
                  <div className="text-[#75FF00] font-mono text-3xl mb-3 opacity-50">
                    {phase.step}
                  </div>
