...
import { ArrowRight, ChevronLeft, ChevronRight, Search, MapPin, TrendingUp, Star } from 'lucide-react';
            ...
            <div>
              ...
              >
                <ExplosiveEntrance delay={0.2}>
                  ...
                  >
                    <motion.span 
                      className="text-[#00D0FF] text-sm font-mono"
                    >
                ...
                fallback={
                  ...
                  >
                    ...
                    <span className="text-[#75FF00]">
                      <TypewriterText 
                        words={['SEO Dominance', 'Digital Growth', 'Marketing Automation', 'Data Intelligence']}
                      />
                    </span>
                    <br />
              ...
              >
                Full-stack digital marketing, SEO optimization, and automation solutions powered by data intelligence and cutting-edge technology.
              </motion.p>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#C2C2CC]">287% Organic Traffic Increase</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-[#00D0FF] rounded-full" />
                  <span className="text-[#C2C2CC]">1st Page Google Rankings</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-[#75FF00] rounded-full" />
        ...
        {currentSlide === 1 && (
          ...
          >
            ...
            <div>
              ...
              >
                Dominate{' '}
                <span className="text-[#75FF00]">Local Search</span>
                <br />
              ...
              <motion.p 
                ...
                transition={{ delay: 0.5 }}
              >
                Advanced local SEO strategies that put your business on the map. From Google My Business optimization to local citations and review management.
              </motion.p>
              ...
              >
                <div className="bg-[#1A1A22] border border-[#00D0FF]/20 rounded-lg p-4 backdrop-blur-sm">
                  ...
                  <div className="text-[#75FF00] font-mono text-xl mb-1">300%</div>
                  <div className="text-[#C2C2CC] text-sm">Map Pack Visibility</div>
                </div>
                <div className="bg-[#1A1A22] border border-[#75FF00]/20 rounded-lg p-4 backdrop-blur-sm">
                  <Star className="text-[#75FF00] mb-2" size={24} />
                  <div className="text-[#00D0FF] font-mono text-xl mb-1">4.8★</div>
                  <div className="text-[#C2C2CC] text-sm">Avg Client Rating</div>
                </div>
                <div className="bg-[#1A1A22] border border-[#00D0FF]/20 rounded-lg p-4 backdrop-blur-sm">
                  <Search className="text-[#00D0FF] mb-2" size={24} />
                  <div className="text-[#75FF00] font-mono text-xl mb-1">Top 3</div>
                  <div className="text-[#C2C2CC] text-sm">Local Rankings</div>
                </div>
                <div className="bg-[#1A1A22] border border-[#75FF00]/20 rounded-lg p-4 backdrop-blur-sm">
                  <TrendingUp className="text-[#75FF00] mb-2" size={24} />
                  <div className="text-[#00D0FF] font-mono text-xl mb-1">450%</div>
                  <div className="text-[#C2C2CC] text-sm">Call Volume Increase</div>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center mb-6">
                  <div className="inline-block px-4 py-2 bg-[#75FF00]/10 border border-[#75FF00]/30 rounded-md mb-4">
                    <span className="text-[#75FF00] text-sm font-mono">GOOGLE MY BUSINESS</span>
                  </div>
                  <h3 className="text-white text-2xl mb-2">Verified Business Profile</h3>
                  <p className="text-[#C2C2CC]">Optimized for Maximum Visibility</p>
                </div>

                {/* GMB Stats */}
                <div className="space-y-4">
                  {[
                    { label: 'Profile Views', value: '+543%', color: '#00D0FF' },
                    { label: 'Website Clicks', value: '+387%', color: '#75FF00' },
                    { label: 'Direction Requests', value: '+298%', color: '#00D0FF' },
                    { label: 'Phone Calls', value: '+421%', color: '#75FF00' },
                  ].map((stat, idx) => (
                    <div key={idx}>
                      <div className="flex justify-between mb-2">
                        <span className="text-[#C2C2CC] text-sm">{stat.label}</span>
                        <span className="font-mono text-sm" style={{ color: stat.color }}>{stat.value}</span>
                      </div>
                ...
                <div className="mt-6 pt-6 border-t border-[#00D0FF]/20 text-center">
                  ...
                  <p className="text-[#C2C2CC] text-sm mt-2">Average Client Rating</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
