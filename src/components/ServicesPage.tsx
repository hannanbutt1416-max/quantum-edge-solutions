  ...
  const services = [
    {
      ...
      description:
        "Precision-targeted campaigns powered by advanced analytics and AI optimization",
      features: [
    ...
    },
    {
      ...
      description:
        "End-to-end automation systems that maximize efficiency and scale operations",
      features: [
    ...
    },
    {
      ...
      description:
        "Custom SaaS platforms built for scalability, performance, and security",
      features: [
      ...
      <section className="relative py-20 overflow-hidden hex-pattern">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-[#C2C2CC] text-xl max-w-3xl mx-auto">
            Full-stack digital services engineered for performance, precision,
            ...
            >
              <div className={index % 2 === 1 ? "lg:col-start-2" : ""}>
                ...
                <div className="inline-block mb-4 px-3 py-1 bg-[#00D0FF]/10 border border-[#00D0FF]/30 rounded-md">
                  <span className="text-[#00D0FF] text-xs font-mono">
                    {service.tagline}
                  </span>
                </div>
                <h2 className="text-white mb-4 text-4xl">{service.title}</h2>
                <p className="text-[#C2C2CC] text-lg mb-8">
                  {service.description}
                </p>
              ...
              >
                <Card className="bg-[#1A1A22] border-[#00D0FF]/30 glow-cyan">
                  <CardContent className="pt-6">
                    <div className="mb-6">
                      <div className="text-[#C2C2CC] mb-4 font-mono text-sm">
                        PERFORMANCE METRICS
                      </div>
                    ...
                    {service.metrics.map((metric, idx) => (
                      <div key={idx} className="mb-6 last:mb-0">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-[#75FF00] font-mono text-2xl metric-glow">
                            {metric.value}
                          </span>
                        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {packages.map((pkg, index) => (
              ...
              >
                <CardHeader>
                  {pkg.featured && (
                    <div className="text-[#75FF00] text-xs font-mono mb-2">
                      RECOMMENDED
                    </div>
                  )}
                  <CardTitle className="text-white">{pkg.name}</CardTitle>
                  <div className="mt-4">
                    <span className="text-[#75FF00] font-mono text-3xl">
                      {pkg.price}
                    </span>
                  ...
                  <ul className="space-y-3 mb-6">
                    {pkg.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start space-x-2">
                        <CheckCircle
                          className="text-[#00D0FF] flex-shrink-0 mt-0.5"
                          size={16}
                        />
                        <span className="text-[#C2C2CC] text-sm">
                          {feature}
