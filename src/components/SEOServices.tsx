  ...
  const seoServices = [
    {
      ...
      title: "Technical SEO",
      description:
        "Site architecture optimization, schema markup, and core web vitals",
      features: [
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-white mb-4 text-4xl md:text-5xl">
            Dominate{" "}
            <span className="text-[#75FF00]">Local Search Results</span>
          </h2>
          <p className="text-[#C2C2CC] text-xl max-w-3xl mx-auto">
            Advanced SEO strategies powered by data intelligence to increase
            visibility, drive qualified traffic, and dominate your local market
          </p>
        </motion.div>
        ...
        >
          <div>
            <h3 className="text-white mb-6 text-3xl">
              Complete <span className="text-[#75FF00]">Local SEO</span>{" "}
              Solution
            </h3>
            <p className="text-[#C2C2CC] mb-8 leading-relaxed">
              Our comprehensive local SEO service ensures your business appears
              in local search results, Google Maps, and drives qualified local
              traffic. We optimize every aspect of your local presence.
            </p>
