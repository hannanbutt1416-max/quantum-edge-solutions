...
export function FloatingLogos() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        className="absolute top-20 left-10 opacity-5 animate-float"
      ...
      <div
        className="absolute top-40 right-20 opacity-5 animate-float-slow"
      ...
      <div
        className="absolute bottom-32 left-32 opacity-5 animate-float"
      ...
      <div
        className="absolute bottom-20 right-10 opacity-5 animate-float-slow"
      ...
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-3 animate-float-slow"
